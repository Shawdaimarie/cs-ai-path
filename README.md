...
- Practitioners who can train and deploy models but want to understand the mechanisms underneath
- Anyone who intends to read, reproduce, and eventually contribute to the primary literature
...
| [06 · LLMs & Alignment](06-llms-and-alignment/) | Transformer architecture, pretraining, RLHF, safety | 100 |
...
3. **Publish each capstone** to your own repository before starting the next tier. The record of work is part of the training.
...
- **Mechanism before abstraction.** Automatic differentiation is implemented by hand before any framework is introduced.
- **Primary sources.** Where a foundational paper exists, it is assigned directly rather than summarized.
- **Alignment is core material.** The safety and evaluation literature is part of Tier 06, not an appendix.
- **Subject to revision.** A resource is replaced the moment a stronger one is identified. See [CONTRIBUTING.md](CONTRIBUTING.md).
